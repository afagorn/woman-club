                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        <div class="form-group {{$errors->has('slug') ? 'has-danger' : ''}}">
                            ...
                            <input type="text" id="input-description" name="slug" value="{{old('slug', $product->slug)}}" class="form-control {{$errors->has('slug') ? 'is-invalid' : ''}}" >
                        ...
                        <div class="form-group {{$errors->has('name') ? 'has-danger' : ''}}">
                            ...
                            <input type="text" id="input-name" name="name" value="{{old('name', $product->name)}}" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" >
                        ...
                        <div class="form-group {{$errors->has('description') ? 'has-danger' : ''}}">
                            ...
                            <textarea id="input-description" name="description" class="form-control {{$errors->has('description') ? 'is-invalid' : ''}}">{{old('description', $product->description)}}</textarea>
                        ...
                        <div class="form-group {{$errors->has('cost') ? 'has-danger' : ''}}">
                            ...
                            <input type="text" id="input-description" name="cost" value="{{old('cost', $product->cost)}}" class="form-control {{$errors->has('cost') ? 'is-invalid' : ''}}" >
